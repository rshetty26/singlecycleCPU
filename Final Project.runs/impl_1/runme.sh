...
HD_PWD='C:/Users/rithv/Documents/CMPEN 331/Final Project/Final Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log single_cycle_computer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source single_cycle_computer.tcl -notrace
