...
HD_PWD='C:/Users/rithv/Documents/CMPEN 331/Final Project/Final Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_cycle_computer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_cycle_computer.tcl
